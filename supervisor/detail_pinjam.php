                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    data-id="<?= $pinjam['id_pinjam'];?>" data-judul="<?= $pinjam['judul'];?>"
                                                    data-nama="<?= $pinjam['nama'];?>" data-tgl_pinjam="<?= $pinjam['tgl_pinjam'];?>" data-tgl_kembali="<?= $pinjam['tgl_kembali'];?>" ><i class="fa fa-edit"></i> Edit Detail</a></td>
                                                    <td><a class="btn btn-sm btn-warning " href="fungsi/hapus.php?id_pinjam=<?= $pinjam['id_pinjam']?>" onClick="return confirm('Kembalikan Buku <?= $pinjam["judul"];?> Atas Nama <?= $pinjam["nama"];?>??')"> <i class="fa fa-book-open"></i> Kembalikan Buku</a></td>
