                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <a href='#' class='btn btn-sm btn-success col-sm-2 float-right' id="pinjamBuku" data-toggle='modal'  data-target='#tambahModal' 
                                                    data-judul="<?= $buku['judul'];?>" ><i class="fa fa-plus"></i> Pinjam Buku Ini</a>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
