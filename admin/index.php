                    ...
                    <div class="row mb-3">
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        while($overdue = mysqli_fetch_array($query)){
                                            $return_date = date_create($overdue['return_date']);
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <?php 
                                    ...
                                    while($data = mysqli_fetch_assoc($query)) {
                                        ?>
                                <h1 class="h3 mb-0 text-gray-800">College Data</h1>
                                <div class="d-flex flex-row-reverse align-items-center col-md-3 ">
                                    <a href='#' class='btn btn-sm btn-primary col-md-9 p-2 font-weight-bold' id="editData" data-toggle='modal' data-id="<?= $data['id']?>" data-target='#editModal'><i class="fa fa-school"></i> Edit College Data</a>
                                </div>
                            </div>
                            <div class="row">
                                            ...
                                            <table class="table align-items-center table-flush">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $data['owner_status'];?></td> 
                                                    </tr>
                                                    <tr>
                                                        <th>College Establishment Decree</th>
                                                        <td><?= $data['college_sk'];?></td> 
                                                    </tr>
                                                    <tr>
                        ...
                        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModal">Edit College Data</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                    </div>
                                    ...
                                    <form action="functions/process_edit.php" method="POST" role="form" enctype="multipart/form-data">
                                        <input type="hidden" name="id" id="id">
                                            <div class="form-group">
                                                <label class=" col-form-label" for="college_name">College Name</label>
                                                <input type="text" class="form-control" name="college_name" id="college_name" placeholder="Full College Name">
                                            </div>
                                            <div class="form-group">
                                                <label class=" col-form-label" for="npsn">College NPSN</label>
                                                <input type="text" class="form-control" name="npsn" id="npsn" placeholder="College NPSN" >
                                            </div>
                                            <div class="form-group">
                                                <label class=" col-form-label" for="status">College Status</label>
                                                <input type="text" class="form-control" name="status" id="status" placeholder="College Status">
                                            </div>
                                            <div class="form-group">
                                                <label class=" col-form-label" for="accreditation">College Accreditation</label>
                                                <input type="text" class="form-control" name="accreditation" id="accreditation" placeholder="Current College Accreditation" >
                                            </div>
                                            <div class="form-group">
                                                <label class=" col-form-label" for="education_form">Education Form</label>
                                                <input type="text" class="form-control" name="education_form" id="education_form" placeholder="Current Education Form">
                                            </div>
                                            <div class="form-group">
                                                <label class=" col-form-label" for="owner_status">Ownership Status</label>
                                                <input type="text" class="form-control" name="owner_status" id="owner_status" placeholder="College Ownership Status">
                                            </div>
                                            <div class="form-group">
                                                <label class=" col-form-label" for="college_sk">College Establishment Decree</label>
                                                <input type="text" class="form-control" name="college_sk" id="college_sk" placeholder="College Establishment Decree">
                                            </div>
                                            <div class="form-group">
                                                <label class=" col-form-label" for="sk_date">Establishment Date</label>
                                                <input type="text" class="form-control" name="sk_date" id="sk_date" placeholder="Establishment Date">
                                            </div>
                                            <div class="form-group">
                                                <label class=" col-form-label" for="permit_sk">Operational Permit Decree</label>
                                                <input type="text" class="form-control" name="permit_sk" id="permit_sk" placeholder="Operational Permit Decree">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class=" col-form-label" for="photo">College Logo</label>
                                                <input type="file" class="form-control" name="photo" id="photo">
                                            </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-primary" value="editCollege" name="editCollege">Edit Data</button>
                                    </div>
                                        </form>
                                </div>
                            </div>
