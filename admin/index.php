                        ...
                        <div class="container-fluid" id="container-wrapper">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                ...
                                <div class="d-flex flex-row-reverse align-items-center col-md-3 ">
                                    <a href='#' class='btn btn-sm btn-primary col-md-9 p-2 font-weight-bold' id="ubahData" data-toggle='modal' data-id="<?= $data['id']?>" data-target='#tambahModal'><i class="fa fa-school"></i> Ubah Data Sekolah</a>
                                </div>
                            </div>
                            <div class="row">
